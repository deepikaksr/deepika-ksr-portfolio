        ...
        <div className="flex items-center justify-center lg:justify-end h-full">
          <div className="relative w-[26rem] h-[26rem] group -translate-x-10">
            ...
            <div className="relative w-full h-full">
              ...
              {/* Inner white ring and image container */}
              <div className="absolute inset-2 bg-white rounded-full p-2">
                <div className="w-full h-full rounded-full overflow-hidden">
                  <img
                    src={`${import.meta.env.BASE_URL}lovable-uploads/deepika_photo.png`}
                    alt="Deepika KSR"
                    className="w-full h-full object-cover scale-[1.50] translate-x-10"
                  />
                </div>
              </div>
            </div>
