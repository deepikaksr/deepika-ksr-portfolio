...
const About = () => {
  ...
  const tabs = [
    ...
    { 
      ...
      content: {
        ...
        description: "Currently pursuing M.Sc. in AI & ML with a stellar 9.22 CGPA, I've consistently demonstrated academic excellence while actively participating in hackathons and technical competitions.",
    ...
    { 
      ...
      content: {
        ...
        description: "I specialize in developing intelligent systems, from machine learning models to full-stack applications. My work spans across computer vision, NLP, AI Agents, LLM, and modern web technologies.",
  ...
  const achievements = [
    { metric: "9.22", label: "CGPA", color: "text-blue-600", bg: "bg-blue-50" },
