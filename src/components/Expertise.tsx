  ...
  const categories = [
    {
      ...
      skills: [
        ...
        { name: 'LLMs', level: 90, description: 'Large Language Models' },
        { name: 'AI Agents', level: 85, description: 'Autonomous Workflows' }
      ]
    },
    {
      id: 'programming',
      ...
      skills: [
        ...
        { name: 'JavaScript', level: 65, description: 'React, Node.js' },
    ...
    },
    {
      ...
      skills: [
        { name: 'React.js', level: 80, description: 'Modern UI Development' },
        { name: 'Node.js', level: 80, description: 'Backend API Development' },
        { name: 'MongoDB', level: 70, description: 'NoSQL Database' },
        { name: 'MySQL', level: 70, description: 'Relational Database' },
        { name: 'Flutter & Firebase', level: 90, description: 'Cross-platform Mobile & BaaS' }
      ]
    },
    {
      id: 'tools',
      ...
      skills: [
        ...
        { name: 'Plotly & Matplotlib', level: 82, description: 'Data Visualization & Dashboards' },
        { name: 'Streamlit & Flask', level: 88, description: 'ML App Development & APIs' },
        { name: 'AWS / Azure', level: 70, description: 'Cloud Services & Deployment' },
